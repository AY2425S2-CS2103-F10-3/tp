...
public class SampleDataUtil {
    public static Person[] getSamplePersons() {
        ...
        LocalDateTime sampleDatetime2 = LocalDateTime.of(2025, 5, 13, 12, 0);
        return new Person[] {
