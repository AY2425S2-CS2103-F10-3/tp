...
public class CommandTestUtil {
    ...
    public static final String VALID_LESSON_AMY = "Elementary Maths;2025-12-12T12:00:00";
    public static final String VALID_LESSON_BOB = "Elementary Maths;2025-12-12T12:00:00";
    ...
    /**
     * Convenience wrapper to {@link #assertCommandSuccess(Command, Model, CommandResult, Model)}
     * that takes a string {@code expectedMessage} and {@code expectedLessons}.
     */
    public static void assertCommandSuccess(Command command, Model actualModel, String expectedMessage,
                                            Model expectedModel, String expectedLessons) {
        CommandResult expectedCommandResult = new CommandResult(expectedMessage, expectedLessons);
        assertCommandSuccess(command, actualModel, expectedCommandResult, expectedModel);
    }
