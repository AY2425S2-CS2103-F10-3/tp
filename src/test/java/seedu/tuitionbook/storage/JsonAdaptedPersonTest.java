...
import static seedu.tuitionbook.storage.JsonAdaptedPerson.MISSING_FIELD_MESSAGE_FORMAT;
...
public class JsonAdaptedPersonTest {
    ...
    private static final Lesson INVALID_LESSON_BAD_MODULE_NAME = new Lesson("INVALID-lesson-name",
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(INVALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_TAGS, VALID_LESSONS);
    ...
    @Test
    public void toModelType_invalidLessonModuleName_throwsIllegalValueException() {
        List<JsonAdaptedLesson> invalidLesson = new ArrayList<>(VALID_LESSONS);
        invalidLesson.add(new JsonAdaptedLesson(INVALID_LESSON_BAD_MODULE_NAME));
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_TAGS, invalidLesson);
        assertThrows(IllegalValueException.class, person::toModelType);
    }
